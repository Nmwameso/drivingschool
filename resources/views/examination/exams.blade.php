                        ...
                        @if(count($exam) > 0)
                            @foreach($exam  as $exam)
                                <tr>
                                    ...
                                    <td><a href="{{url("/fetch3/{$exam->id}")}}" onClick="window.open('{{url("/fetch3/{$exam->id}")}}','popup2','width=1100,height=450,scrollbars=yes,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,right=20,top=100, left=120'); return false">BOOKING</a></td>
                                </tr>
